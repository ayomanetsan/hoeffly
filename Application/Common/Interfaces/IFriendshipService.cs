...
{
    Task<Guid> SendFriendRequestAsync(string recipientEmail, CancellationToken cancellationToken);
    ...
    Task<(IEnumerable<Friendship> friends, int totalPages, string userEmail)> GetFriendsAsync(
        int pageNumber,
        int pageSize,
